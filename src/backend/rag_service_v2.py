"""
RAG Service - Lightweight Edition
Keyword-based knowledge retrieval for technical support (BM25)
No neural models = Fits in 256MB RAM
"""
import os
import pickle
...
class RAGService:
    """
    Super-lightweight RAG Service using BM25
