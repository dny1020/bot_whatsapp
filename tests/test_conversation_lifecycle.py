"""
Integration Tests for Conversation Lifecycle (Simplified Structure)
"""
import pytest
import asyncio
...
from src.core.database import Base, User, Conversation, Message, ConversationStatus
from src.core.bot import session_manager, user_service, message_processor
